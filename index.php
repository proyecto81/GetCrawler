    ...
    <div id="maincont" class="section group">
      <div class="col span_10_of_12">
        <p>Ultima enviada:<strong>
          <?PHP if(isset($_POST['url'])){echo $_POST['url']; } ?>
          </strong></p>
        ...
        <label for="links_sec">links_sec<br />
          <input name="links_sec" type="text" id="links_sec" style="width:70%" value="<?PHP if(isset($_POST['links_sec'])){echo $_POST['links_sec']; } ?>" />
        </label>
        <div class="separador"></div>
        <label for="links_ter">links_ter<br />
          <input name="links_ter" type="text" id="links_ter" style="width:70%" value="<?PHP if(isset($_POST['links_ter'])){echo $_POST['links_ter']; } ?>" />
        </label>
        <div class="separador"></div>
        template a
...
<div class="separador"></div>
    ...
    <div id="maincont" class="section group">
      <div class="col span_6_of_12 bg_green">
        <?PHP if(isset($old_titulo)){ echo htmlentities($old_titulo); } ?>
      </div>
      <div class="col span_6_of_12 bg_green">
        <?PHP if(isset($old_cont)){ echo htmlentities($old_cont); } ?>
      </div>
    </div>
  </section>
</form>
