...
public function generarPagina($url, $temp) {
		...
		$link_sec_nuevo  = '<!--#include virtual="/2015/inc/links_secundarios/menu_humanidades.asp" -->';
		$newphrase = trim(str_replace("{{link_secundarios}}", $link_sec_nuevo, $newphrase));

		if($temp == '2'){
			$link_izq_nuevo  = '<!--#include virtual="/2015/inc/links_izquierda/banners_c_cebj.asp" -->';
