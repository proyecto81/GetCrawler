...
class CrearSitio
{
	...
	public function generarPagina($url, $temp, $links_sec = '', $links_ter = '')
	{
		...
		if (substr($nombre_de_archivo, 0, 1) == '_') {
			$nombre_de_archivo = substr($nombre_de_archivo, 1);
		}
		...
		if ($temp == '1') {
			...
			$template_1 = file_get_contents("template1.html");
			$old_titulo_sub = "";
		} elseif ($temp == '2') {
			// TEMPLATE BASE TERCIARIO
			$template_1 = file_get_contents("template2.html");
